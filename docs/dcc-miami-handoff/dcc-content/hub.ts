/**
 * DCC Miami /institutions — institutional technology services page.
 * Voice: Digital Culture Center Miami offers this. Moises Sanabria is founder/lead, not the page identity.
 * Art-practice links go to https://moises.tech. Case studies may stay on moises.tech until DCC ports them.
...
export const institutionsHub = {
  ...
  artBand: {
    ...
    items: [
      { src: SMART_SHOPPERS, alt: 'Smart Shoppers sculpture', href: 'https://moises.tech/art/smart-shoppers', label: 'Smart Shoppers / CONTINUUM · MUNAG' },
      { src: TOUCH_GRASS, alt: 'Touch Grass / Doomscrolling installation', href: 'https://moises.tech/art/doomscrolling_treadmill', label: 'Touch Grass · Chroma / Superblue' },
      { src: MOMUS, alt: 'Technofetishism at MOMus', href: 'https://moises.tech/calendar/exhibitions', label: 'Technofetishism · MOMus' },
      { src: AFIRME, alt: 'Algoritmica Intima exhibition', href: 'https://moises.tech/calendar/exhibitions', label: 'Algoritmica Intima · Mexico City' },
    ],
  },
  organizations: [
    {
