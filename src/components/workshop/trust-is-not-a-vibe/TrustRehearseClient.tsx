  ...
  return (
    <div className={cn(trust.shell, 'pb-24')}>
      <div className={cn(trust.main, 'max-w-6xl')}>
        <p className={trust.eyebrow}>Facilitator · not indexed</p>
        <h1 className={cn(trust.title, 'mt-2')}>Rehearse · {TRUST_TITLE}</h1>
        <p className={cn(trust.body, 'mt-3 max-w-2xl')}>
          Live 30-minute clock and speaker notes. Same interactions as the public lab. Problem name in the room:{' '}
          {TRUST_PROBLEM_NAME}. {TRUST_THESIS}
        </p>
