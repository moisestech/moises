...
/** Archived Touch Grass hotel studies — four-image placeholder layout */
export function LegacyHotelStudySelector({ studies }: { studies: NvHotelStudy[] }) {
      ...
      <div role="tabpanel" className="space-y-8">
        <div>
          ...
          <p className="mt-3 text-xs text-stone-500">
            Site-adaptation study — not a claim that this property is confirmed for 2026.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-8">
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide mb-2">Installation elements</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide mb-2">Constraints</h4>
            <ul className="list-disc pl-5 space-y-1 text-sm text-stone-600 dark:text-stone-400">
