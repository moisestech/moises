      ...
      <article className="mx-auto max-w-3xl px-4 sm:px-6 pt-28 sm:pt-32 pb-20 sm:pb-28">
        <header className="mb-12 sm:mb-16">
          ...
          <p className="text-xl text-stone-600 dark:text-stone-400 font-medium mb-6">
            Dual proposal options for temporary hotel installation, Art Week 2026
          </p>
        ...
        <section className="mb-14">
          <p className="text-sm text-stone-600 dark:text-stone-400 leading-relaxed border-l-2 border-stone-400 pl-4">
            This packet is public and shareable with reviewers and with The Idea Center / MDC cohort as an
            example of how grant proposals are structured — concept, site imagination, materials, budget, and
            prior work.
          </p>
        </section>

        <section className="mb-16">
          <h2 className="text-2xl font-semibold mb-6">Proposal options</h2>
          <ul className="space-y-6">
            {noVacancyProposalCards.map((card) => (
              <li key={card.slug}>
                <Link
                  href={card.href}
        ...
        <section className="mb-16">
          ...
          <p className="text-xs text-stone-500 mb-4">Shared for both proposals · Submittable field</p>
