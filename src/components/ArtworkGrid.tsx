                        ...
                        <article className="flex flex-col md:flex-row h-auto md:h-[400px] lg:h-[500px] overflow-hidden w-full">
                            ...
                            <div 
                                className={`w-full md:w-1/3 p-6 md:p-8 order-2 ${
                                    isEven ? 'md:order-first md:pl-16 md:pr-8' : 'md:order-last md:pr-16 md:pl-8'
                                } ${bgColor} md:bg-opacity-100 bg-opacity-0`}
                            >
                                <h2 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-2 md:mt-20 font-bold ${textColor} md:text-black md:dark:text-white`}>
                                    {artwork.title}
                                </h2>
                                {artwork.location && (
