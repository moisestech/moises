      ...
      <div className="lg:grid lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:min-h-[min(88vh,860px)] lg:items-stretch">
        <div className="relative h-[min(52vh,420px)] sm:h-[min(56vh,480px)] lg:h-auto lg:min-h-[520px]">
          {imgError ? (
            ...
            >
              <span className="text-[10px] uppercase tracking-[0.35em] text-zinc-600">Hero artwork</span>
            </div>
          ) : (
            <>
              <Image
              ...
              />
              <div
                className="absolute inset-0 bg-gradient-to-t from-black via-black/55 to-black/25 lg:from-black/75 lg:via-black/35 lg:to-black/20"
                aria-hidden
              />
              <div
                className="absolute inset-0 bg-gradient-to-r from-black/70 via-transparent to-black/40 lg:hidden"
                aria-hidden
              />
            </>
          )}
        ...
        <div
          className={cn(
            ...
            'bg-zinc-950',
            'border-t border-zinc-800/80 lg:border-t-0 lg:border-l lg:border-zinc-800/80'
          )}
        >
          <p className="text-xs sm:text-sm uppercase tracking-[0.2em] text-zinc-500 mb-4 sm:mb-5">
            Workshop · live performance
          </p>
          <h1 className="text-4xl sm:text-5xl md:text-5xl xl:text-6xl font-semibold tracking-tight text-zinc-50 leading-[1.05] max-w-xl">
            Learn AI Without Losing Yourself
          </h1>
          <p className="mt-5 sm:mt-6 text-lg sm:text-xl text-zinc-300 font-light max-w-xl leading-snug">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3 sm:gap-4">
            <a
              ...
              className="inline-flex justify-center items-center rounded-sm bg-zinc-100 text-zinc-950 px-6 py-3.5 text-sm font-medium tracking-wide hover:bg-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-lime-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
            >
              Bring this to your space
            </a>
            <a
              href="#inquiry"
              className="inline-flex justify-center items-center rounded-sm border border-zinc-600 text-zinc-100 px-6 py-3.5 text-sm font-medium hover:bg-zinc-900 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950"
            >
              Request details
            </a>
          </div>
