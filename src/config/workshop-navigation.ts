      ...
      items: [
        {
          ...
          items: [
            ...
            {
              title: "Examples",
              href: "/workshop/own-your-digital-presence/day/1/session/1/examples",
              icon: Monitor,
              description: "View successful artist websites"
            },
            {
              title: "Analysis",
              href: "/workshop/own-your-digital-presence/day/1/session/1/analysis",
              icon: PenTool,
              description: "Analyze website elements"
            },
            {
              title: "Sustainability",
              href: "/workshop/own-your-digital-presence/day/1/session/1/sustainability",
              icon: Layers,
            ...
            },
            {
              ...
              items: [
                ...
                {
                  title: "Vocabulary",
                  href: "/workshop/own-your-digital-presence/day/1/session/1/fundamentals/vocabulary",
                  icon: MessageSquare,
            ...
            {
              title: "Resources",
              href: "/workshop/own-your-digital-presence/day/1/session/1/resources",
              icon: FileText,
          ...
          items: [
            {
              ...
              items: [
                {
                  title: "Foundations",
                  href: "/workshop/own-your-digital-presence/day/1/session/2/content/foundations",
                  icon: Layers,
                  description: "Core content strategy principles"
                },
                {
                  title: "Content Organization",
                  href: "/workshop/own-your-digital-presence/day/1/session/2/content/organization",
            ...
            },
            {
              ...
              href: "/workshop/own-your-digital-presence/day/1/session/2/technical",
              icon: Code,
              description: "Technical setup and implementation"
            },
            {
              title: "Final Steps",
              href: "/workshop/own-your-digital-presence/day/1/session/2/final",
              icon: CheckSquare,
              description: "Finalizing and reviewing work"
            }
          ]
        },
        {
          title: "Participants",
          href: "/workshop/own-your-digital-presence/day/1/participants",
          icon: Users,
          ...
          items: [
            {
              ...
              href: "/workshop/own-your-digital-presence/day/2/session/1/platform-selection",
              icon: Monitor,
              description: "Choose your website platform"
            },
            {
              title: "Setup",
              href: "/workshop/own-your-digital-presence/day/2/session/1/setup",
              icon: Laptop,
              description: "Set up your development environment"
            },
            {
              title: "Templates",
              href: "/workshop/own-your-digital-presence/day/2/session/1/templates",
              icon: FileText,
              description: "Select and customize templates"
            }
          ]
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              icon: ArrowUpRight,
              description: "Prepare and launch your website"
            }
          ]
        }
      ]
