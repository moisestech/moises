...
export const playwireApplicationMeta = {
  ...
  /** Interactive RAMP demo — hosted on Infra24, not moises.tech */
  demoUrl: 'https://dcc.miami/applications/playwire',
...
export const playwireEmailToJarrett = {
  subject: 'Former Playwire data/solutions — interested in returning',
  body: `Hi Jarrett,
...
I put together a short private dossier with role-fit evidence and selected work:
...
export const playwireEmailToJayson = {
  subject: 'Former Playwire — interested in returning',
  body: `Hi Jayson,
...
Supporting dossier (private link): https://moises.tech/opportunities/playwire
...
export const playwireTalkingPoints = {
  strongestAngles: [
    ...
    'Homework on current RAMP direction: Managed/Self-Service, Flex Suite, PARMM, and QPT yield framing.',
  ...
  honestGaps: [
    ...
    'Ad-tech domain is 2021–2022 vintage — dossier and homework show current RAMP/PARMM/Flex narrative.',
    'Careers page has limited public reqs — warm intro is primary path.',
  ],
  recommendedFraming:
    'Returning alum who already shipped publisher solutions and data pipelines — now brings full-stack/AI product depth and a focused private dossier.',
} as const;
