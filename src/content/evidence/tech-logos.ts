...
export const techLogoRegistry: Record<string, TechLogoEntry> = {
  ...
  aws: { id: 'aws', label: 'AWS', imageSrc: `${jobsCdn}/v1780254939/jobs/Amazon-S3-Logo_mmkpap.png` },
  snowflake: { id: 'snowflake', label: 'Snowflake', imageSrc: si('snowflake', '29B5E8') },
  tableau: { id: 'tableau', label: 'Tableau', imageSrc: si('tableau', 'E97627') },
  cloudinary: { id: 'cloudinary', label: 'Cloudinary', imageSrc: si('cloudinary', '3448C5') },
  'adobe-premiere': { id: 'adobe-premiere', label: 'Adobe Premiere', imageSrc: si('adobepremierepro', '9999FF') },
  'adobe-after-effects': {
    id: 'adobe-after-effects',
    label: 'After Effects',
    imageSrc: si('adobeaftereffects', '9999FF'),
  },
  canva: { id: 'canva', label: 'Canva', imageSrc: si('canva', '00C4CC') },
  capcut: { id: 'capcut', label: 'CapCut', imageSrc: si('capcut', '000000'), imageClassName: 'dark:invert' },
  tiktok: { id: 'tiktok', label: 'TikTok', imageSrc: si('tiktok') },
  instagram: { id: 'instagram', label: 'Instagram', imageSrc: si('instagram', 'E4405F') },
  youtube: { id: 'youtube', label: 'YouTube', imageSrc: si('youtube', 'FF0000') },
