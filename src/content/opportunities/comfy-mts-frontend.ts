  ...
  comingSoon: {
    ...
    items: [
      ...
      },
      {
        ...
        certId: 'PENDING',
        body: 'Optional Mid-Level Vue.js certification — designed as a license-style placeholder. Ranked below a focused OSS PR and working prototype; will not lead the application.',
        badge: 'Coming soon',
      },
      {
        id: 'testing-credential',
        kind: 'cert',
        title: 'Vitest / Playwright credential',
        certCredential: 'Frontend Test Engineering',
        certIssuer: 'ComfyUI_frontend patterns · self-directed',
        certHolder: 'Moises Sanabria',
        certId: 'PENDING',
        body: 'Placeholder license face for Vitest + Playwright fluency against Comfy conventions. Replaced by real badge or course certificate when earned — or by shipped test PRs, which rank higher.',
        badge: 'Coming soon',
      },
      {
...
export const comfyMtsFrontendOpportunity: Opportunity = {
  ...
  seo: {
    ...
    description:
      'Frontend work sample for Comfy MTS Frontend — Lore Machine × ComfyUI case study, Output Provenance Explorer demo, and honest Vue ramp.',
    indexable: false,
  },
  ...
  heroPrimaryCta: { label: 'View ComfyUI Experience', href: '#comfyui-experience' },
  heroSecondaryCta: { label: 'View Provenance Explorer', href: '#provenance-explorer' },
  navItems: [
    { id: 'hero', label: 'Overview' },
    { id: 'credibility', label: 'Proof' },
    { id: 'comfyui-experience', label: 'Lore × ComfyUI' },
    { id: 'provenance-explorer', label: 'Demo' },
  ...
  hero: {
    ...
    subheadline:
      'Founding frontend engineer and creative technologist. Lore Machine incorporated ComfyUI-powered image workflows; collaborated with Martin on that connection.',
    introParagraphs: [
      'Work-sample page for **Member of Technical Staff, Frontend** — proof first, not a decorated résumé.',
      'Interactive **Output Provenance Explorer**, Lore Machine × ComfyUI case study with honest ownership lanes, and a Vue/LiteGraph ramp track that does not overclaim.',
    ],
