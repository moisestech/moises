...
export const machineSentences = {
  ...
  metadata: [
    ...
    'Central work: Machine Sentence No. 1',
  ...
  coreDistinction: `This is not primarily a software research project, chatbot, website, text-to-image installation, or technology demonstration.

It is a physical studio practice involving sculptural objects, displays, aluminum or steel structures, custom screen housings, mechanical joints, electronics, sound, visible cable circulation, diagrams and prints, small material studies, and one full-scale kinetic sculpture.`,
  whyStudio: `Pioneer Works’ approximately 20 × 11-foot glass-fronted studio, fabrication resources, and public-facing residency culture are required because Machine Sentences must accumulate as objects in space. The work cannot be resolved as a single remote prototype: it needs room for maquettes, frame fragments, cable looms, kinetic testing, and monthly public chapters. The glass studio becomes a public operating theater for an unfinished machine body rather than a problem to tolerate.`,
  seriesOverview: `Machine Sentences is a larger body of work: a model organism for language. Machine Sentence No. 1 is its central full-scale sculpture — a self-standing armature with multiple displays, custom housings, visible cable circulation, sound, and a constrained AI system. Alongside it, smaller grammar studies, diagrams, and screen-based fragments occupy the studio as an evolving installation.`,
  centralWorkBody: `Machine Sentence No. 1 combines a self-standing aluminum armature, multiple displays, custom 3D-printed housings, visible cable circulation, sound, and a constrained AI system. Rather than allowing a model to freely generate form, the artist authors a finite physical grammar — states such as witness, refusal, compression, and chorus — and uses inference only to move the sculpture among those states.

Proposed dimensions are approximately 78 × 48 × 36 inches and remain provisional. Exact screen count, motor systems, and enclosure materials are unresolved. The submitted visual material is a digital and fabrication study; the physical work has not yet been built.`,
...
export const machineSentencesHero: GrantPlaceholderMedia = {
  ...
  caption:
    'Conceptual silhouette study: aluminum armature, screen housings, cable circulation, one figure for scale. Digital study only — not documentary installation photography.',
...
export const machineSentencesPlaceholders: Record<string, GrantPlaceholderMedia> = {
  studioEstablishing: {
    ...
    caption: 'Conceptual view of the glass studio occupied by studies and the central armature. Not a photo of an assigned studio.',
    alt: 'Placeholder full studio establishing study',
  },
  glassVisitorView: {
    label: '[PLACEHOLDER — AUTHENTIC ASSET REQUIRED] Glass-wall visitor view',
    caption: 'Sightline through glass to unfinished machine anatomy and wall diagrams.',
  ...
  fiveMonthEvolution: {
    ...
    caption: 'Vocabulary → Anatomy → Movement → Public testing → Assembly as a single annotated strip.',
  ...
  poweredOff: {
    ...
    caption: 'Sculpture remains readable as object while inactive: dark screens, exposed structure, resting posture.',
  ...
  threeMutations: {
    ...
    caption: 'Same armature in Witness / Refusal / Compression — mutation is physical, not only image change.',
  ...
  materialPivot: {
    ...
    caption: 'Joint study, housing edge, cable route. Fabrication specimen, not a finished install detail.',
    alt: 'Placeholder material and pivot close-up',
  },
  fabricationExploded: {
    label: '[PLACEHOLDER — AUTHENTIC ASSET REQUIRED] Exploded fabrication anatomy',
    caption: 'Base, frame, housings, pivots, controller, cable loom. Conceptual exploded study.',
    alt: 'Placeholder exploded fabrication anatomy',
  },
  secondSundays: {
    label: '[PLACEHOLDER — AUTHENTIC ASSET REQUIRED] Second Sundays public encounter',
    caption: 'Conceptual open-studio chapter: visitors witness incomplete anatomy and revised rules.',
...
export const machineSentencesGrammar = [
  ...
  { element: 'Paired screens or screen clusters', function: 'Clauses' },
  { element: 'Movement', function: 'Punctuation' },
  { element: 'Distributed imagery', function: 'Semantic material' },
...
export const residencyTimelineMonths = [
  ...
  },
  {
    ...
    title: 'Anatomy',
    items: [
      'Full-scale frame fragments',
      'Pivot and joint studies',
      'Cable routing',
      'Electronics and base studies',
    ],
  },
  {
    id: 'month-3',
    ...
    title: 'Movement',
    items: [
      'Constrained inference system',
      'Kinetic control',
      'Distributed screen imagery',
      'Sound and temporal choreography',
    ],
  },
  {
    id: 'month-4',
    ...
    items: [
      'Second Sundays experiments',
      'Visitor language input',
  ...
  },
  {
    ...
    items: [
      ...
      'Documentation',
      'Public workshop',
      'Future fabrication and exhibition plan',
    ],
  },
] as const;

export const studioPlanZones = [
  { id: 'sculpture', label: 'Central full-scale sculpture', x: 35, y: 28, w: 30, h: 36 },
  { id: 'diagrams', label: 'Wall-mounted diagrams', x: 4, y: 8, w: 22, h: 12 },
  { id: 'workbench', label: 'Workbench', x: 68, y: 18, w: 26, h: 18 },
  { id: 'maquettes', label: 'Small maquettes', x: 68, y: 42, w: 18, h: 14 },
  { id: 'materials', label: 'Material tests', x: 4, y: 55, w: 20, h: 14 },
  { id: 'electronics', label: 'Electronics station', x: 72, y: 62, w: 22, h: 16 },
  { id: 'circulation', label: 'Safe circulation', x: 28, y: 70, w: 36, h: 12 },
  { id: 'rest', label: 'Inactive sculpture sightline', x: 38, y: 8, w: 24, h: 10 },
] as const;

export const studioPlanDisclaimer =
  'Conceptual studio plan based on published approximate dimensions. Final studio assignment and conditions unverified.';
...
export const secondSundaysChapters = [
  {
    ...
    number: '01',
    title: 'Vocabulary',
    body: 'Visitors encounter small screen-clause maquettes and movement studies. Feedback sharpens which states are legible before any large kinetic commitment.',
  },
  {
    id: 'anatomy',
    number: '02',
    title: 'Anatomy',
    body: 'Frame fragments, joints, housings, and cable diagrams occupy the glass studio. Incomplete anatomy is part of the public encounter.',
  },
  {
    id: 'movement',
    number: '03',
    title: 'Movement',
    body: 'Constrained kinetic tests and temporal choreography. Failures and revised limits are visible process, not polished demo.',
  },
  {
    id: 'collective',
    number: '04',
    title: 'Collective Sentence',
    body: 'Visitor language enters under authored rules. Public feedback changes constraints and vocabulary — not merely the appearance of generative output.',
  },
  {
    id: 'rest',
    number: '05',
    title: 'Rest State',
    body: 'Powered-off and resting postures prove the work remains sculpture when inactive. Documentation and workshop planning close the chapter.',
  },
] as const;
...
export const facilitiesRelationship = [
  {
    ...
    use: 'Custom housings, joint prototypes, enclosure fragments for screen clauses',
  },
  {
    facility: 'Laser cutting',
    use: 'Frame templates, diagram plates, fixture jigs for modular assembly',
  },
  {
  ...
  {
    facility: 'Tech Lab',
    use: 'Engineering consultation for safe kinetics and additive manufacturing — in service of sculpture, not as the artwork itself',
  },
] as const;
