...
export const wolfsonianSectionAssetPaths: Record<string, string> = {
  ...
  'designed-belief': '/grant/wolfsonian-fellowship/sections/03-psychographic-layer-emotional-pressures.png',
  'society-inside-archive': '/grant/wolfsonian-fellowship/sections/04-agent-society-inside-archive.png',
  'citation-layer': '/grant/wolfsonian-fellowship/sections/05-citation-layer-source-interpretation-uncertainty.png',
  'citation-layer-alt': '/grant/wolfsonian-fellowship/sections/05-citation-layer-alt-simple.png',
  'synthetic-saturation': '/grant/wolfsonian-fellowship/sections/06-synthetic-saturation-memory-becomes-content.png',
...
export const wolfsonianImages: WolfsonianImage[] = [
  ...
  {
    id: 'living-tableau',
    expectedPath: '/grant/wolfsonian-fellowship/sections/04-agent-society-inside-archive.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['society-inside-archive'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782901426/grants/wolfsonian/sections/04-agent-society-inside-archive_cjcbhr.png`,
  ...
  {
    id: 'citation-trail',
    expectedPath: '/grant/wolfsonian-fellowship/sections/05-citation-layer-source-interpretation-uncertainty.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['citation-layer'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782901428/grants/wolfsonian/sections/05-citation-layer-source-interpretation-uncertainty_qdcocz.png`,
  ...
  },
  {
    ...
    expectedPath: '/grant/wolfsonian-fellowship/sections/03-psychographic-layer-emotional-pressures.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['designed-belief'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782901424/grants/wolfsonian/sections/03-psychographic-layer-emotional-pressures_igjox1.png`,
  ...
  },
  {
    ...
    expectedPath: '/grant/wolfsonian-fellowship/sections/06-synthetic-saturation-memory-becomes-content.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['synthetic-saturation'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782901425/grants/wolfsonian/sections/06-synthetic-saturation-memory-becomes-content_rkrjgp.png`,
