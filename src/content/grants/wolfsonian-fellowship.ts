...
export const wolfsonianSectionAssetPaths: Record<string, string> = {
  ...
  'designed-belief': '/grant/wolfsonian-fellowship/sections/03-psychographic-layer-light-with-labels-alt.png',
  'designed-belief-alt': '/grant/wolfsonian-fellowship/sections/03-psychographic-layer-light-abstract-no-text-candidate.png',
  'society-inside-archive': '/grant/wolfsonian-fellowship/sections/04-agent-society-light-with-labels-alt.png',
  'citation-layer': '/grant/wolfsonian-fellowship/sections/05-citation-layer-installation-light-cleanest.png',
  'citation-layer-alt': '/grant/wolfsonian-fellowship/sections/05-citation-layer-stacked-light-with-labels-alt.png',
  'citation-layer-stacked': '/grant/wolfsonian-fellowship/sections/05-citation-layer-stacked-light-cleaner.png',
  'synthetic-saturation': '/grant/wolfsonian-fellowship/sections/06-synthetic-saturation-light-no-text-candidate.png',
  'related-works': '/grant/wolfsonian-fellowship/sections/07-practice-as-evidence-wide.png',
  'fellowship-goals': '/grant/wolfsonian-fellowship/sections/08-fellowship-goals-research-model-prototype.png',
  'art-direction': '/grant/wolfsonian-fellowship/sections/00-art-direction-board-overview.png',
};

const WOLFSONIAN_CDN = 'https://res.cloudinary.com/dck5rzi4h/image/upload';

export const wolfsonianAgentPortraitSrc: Record<string, string> = {
  archivist: `${WOLFSONIAN_CDN}/v1782901407/grants/wolfsonian/agents/archivist_enoxwd.png`,
  worker: `${WOLFSONIAN_CDN}/v1782901403/grants/wolfsonian/agents/worker_ofjxn0.png`,
  futurist: `${WOLFSONIAN_CDN}/v1782901408/grants/wolfsonian/agents/futurist_layjim.png`,
  mourner: `${WOLFSONIAN_CDN}/v1782901407/grants/wolfsonian/agents/mourner_egkmra.png`,
  optimizer: `${WOLFSONIAN_CDN}/v1782901409/grants/wolfsonian/agents/optimizer_kshs4e.png`,
  counterfeit: `${WOLFSONIAN_CDN}/v1782901404/grants/wolfsonian/agents/counterfeit_oz5ee8.png`,
  'orphan-record': `${WOLFSONIAN_CDN}/v1782901405/grants/wolfsonian/agents/orphan-record_gvufzn.png`,
};
...
export const wolfsonianImages: WolfsonianImage[] = [
  {
    id: 'hero',
    expectedPath: '/grant/wolfsonian-fellowship/sections/01-premise-archive-dreams.png',
    sectionAssetPath: wolfsonianSectionAssetPaths.hero,
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782901428/grants/wolfsonian/sections/01-premise-archive-dreams_qzh8vg.png`,
  ...
  {
    id: 'why-wolfsonian',
    expectedPath: '/grant/wolfsonian-fellowship/sections/02-why-wolfsonian-designed-belief.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['why-wolfsonian'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782901422/grants/wolfsonian/sections/02-why-wolfsonian-designed-belief_ftxfw9.png`,
    alt: 'Why The Wolfsonian — industrial modernity, designed belief, and archival object typologies.',
    caption: 'Why The Wolfsonian / Designed Belief',
    role: 'gallery',
    aspect: 'landscape',
  },
  {
    id: 'living-tableau',
    expectedPath: '/grant/wolfsonian-fellowship/sections/04-agent-society-light-with-labels-alt.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['society-inside-archive'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782910334/grants/wolfsonian/sections/04-agent-society-light-with-labels-alt_vmdusq.png`,
    alt: 'A Society Inside the Archive — cast of interpretive agent roles in a living social ecosystem.',
  ...
  {
    id: 'citation-trail',
    expectedPath: '/grant/wolfsonian-fellowship/sections/05-citation-layer-installation-light-cleanest.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['citation-layer'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782910335/grants/wolfsonian/sections/05-citation-layer-installation-light-cleanest_uw22mk.png`,
    alt: 'Every Dream Has a Source — citation layer from archival source through interpretation to uncertainty.',
  ...
  },
  {
    ...
    expectedPath: '/grant/wolfsonian-fellowship/sections/03-psychographic-layer-light-with-labels-alt.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['designed-belief'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782910332/grants/wolfsonian/sections/03-psychographic-layer-light-with-labels-alt_am3ryp.png`,
    alt: 'Psychographic layer — emotional and ideological pressures radiating from archival objects.',
  ...
  },
  {
    ...
    expectedPath: '/grant/wolfsonian-fellowship/sections/06-synthetic-saturation-light-no-text-candidate.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['synthetic-saturation'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782910337/grants/wolfsonian/sections/06-synthetic-saturation-light-no-text-candidate_g6fses.png`,
    alt: 'When Memory Becomes Content — synthetic saturation overwhelming archival specificity.',
  ...
  },
  {
    ...
    expectedPath: '/grant/wolfsonian-fellowship/sections/07-practice-as-evidence-wide.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['related-works'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782901423/grants/wolfsonian/sections/07-practice-as-evidence-wide_vkqdfq.png`,
    alt: 'Related works — practice as evidence connecting prior artworks to the fellowship proposal.',
    caption: 'Practice as Evidence',
    role: 'gallery',
    aspect: 'landscape',
  },
  {
    id: 'installation-render',
    expectedPath: '/grant/wolfsonian-fellowship/sections/08-fellowship-goals-research-model-prototype.png',
    sectionAssetPath: wolfsonianSectionAssetPaths['fellowship-goals'],
    isPlaceholder: false,
    src: `${WOLFSONIAN_CDN}/v1782901430/grants/wolfsonian/sections/08-fellowship-goals-research-model-prototype_seglrb.png`,
    alt: 'Fellowship goals — research model, taxonomy, and prototype for a future installation.',
    caption: 'Research, Model, Prototype',
    role: 'gallery',
    aspect: 'landscape',
  },
];
...
export const wolfsonianStoryBlocks: WolfsonianStoryBlock[] = [
  ...
  },
  {
    ...
    media: { type: 'image', imageId: 'why-wolfsonian' },
    layout: 'textRight',
    interaction: 'hover',
  },
  {
  ...
  },
  {
    ...
    media: { type: 'image', imageId: 'practice-evidence' },
    layout: 'textLeft',
    interaction: 'hover',
  },
  {
...
export const wolfsonianInstitutionalRoles: WolfsonianRole[] = [
  {
    ...
    portraitSrc: wolfsonianAgentPortraitSrc.archivist,
  ...
  },
  {
    ...
    portraitSrc: wolfsonianAgentPortraitSrc.worker,
  ...
  },
  {
    ...
    portraitSrc: wolfsonianAgentPortraitSrc.futurist,
  ...
  },
  {
    ...
    portraitSrc: wolfsonianAgentPortraitSrc.mourner,
  ...
  },
  {
    ...
    portraitSrc: wolfsonianAgentPortraitSrc.optimizer,
  ...
  },
  {
    ...
    portraitSrc: wolfsonianAgentPortraitSrc.counterfeit,
  ...
  },
  {
    ...
    portraitSrc: wolfsonianAgentPortraitSrc['orphan-record'],
