...
const grantDirectoryEntries: GrantDirectoryEntry[] = [
  ...
  },
  {
    ...
    status: 'active',
    summary:
      'INCOMPLETE CONTAINMENT OF A MODEL — civic-forensic listening structure for Gray Area October 2026.',
  },
  {
    ...
    summary: 'Listening structure — aperture states, thermal evidence receipt, Modal inference path.',
  },
  {
    id: 'no-vacancy-2026',
