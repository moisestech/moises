...
export const CAPABILITY_SKILLS: Record<CapabilityPillarId, CapabilitySkill[]> = {
  'ai-engineering': [
    ...
    },
    {
      ...
      status: 'building',
      note: 'Agentic Ops flagship — Building until demo + evals are verified live. Do not claim Proven.',
      evidence: { label: 'Agentic Ops (Building)', href: '/projects/agentic-ops' },
    },
    {
      id: 'mcp-custom',
      name: 'Custom MCP server / client + tools',
      status: 'building',
      note: 'Ships inside Agentic Ops (packages/mcp) — Building until public demo clears.',
      evidence: { label: 'Agentic Ops (Building)', href: '/projects/agentic-ops' },
    },
    {
      id: 'agent-frameworks',
      ...
      status: 'building',
      note: 'n8n agents ship today; Agentic Ops orchestrator is the public ramp.',
      evidence: { label: 'Agentic Ops (Building)', href: '/projects/agentic-ops' },
    },
    {
  ...
  'data-infrastructure': [
    ...
    },
    {
      ...
      name: 'pgvector',
      status: 'building',
      note: 'Agentic Ops retrieval module — verified-live gate before Proven.',
      evidence: { label: 'Agentic Ops (Building)', href: '/projects/agentic-ops' },
    },
    {
      id: 'dbt',
