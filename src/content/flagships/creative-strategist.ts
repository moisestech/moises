...
export const creativeStrategistFlagship = {
  seo: {
    ...
    description:
      'Creative Strategist flagship: brief clarity, cultural insight, channel systems, and AI-accelerated production under human editorial control.',
  },
  eyebrow: 'Hiring flagship · Strategy + production',
  title: 'Creative Strategist',
  subtitle: 'Briefs that survive production. Ideas that survive AI speed.',
  intro:
    'I translate culture, brand constraints, and channel reality into executable creative systems — then stay close enough to production that strategy does not die in the handoff. Generative tools widen exploration; critique, taste, and brand safety decide what ships.',
  primaryCta: {
