...
export const bitmCaseStudies: BitmCaseStudy[] = [
  {
    ...
    publicContext: 'Bakehouse Art Complex — Breadbytes: Artmaking for the Next Generation',
    status: 'Exhibited',
    ...
    plausibility: {
      ...
      institutionalReality:
        'Breadbytes: Artmaking for the Next Generation at Bakehouse Art Complex — public exhibition with institutional install requirements.',
      ...
      approvalsOrDependencies: [
        'Bakehouse Art Complex — Breadbytes exhibition',
        'Gallery power and display requirements',
      ],
    ...
    stages: [
      ...
      { key: 'object', label: 'OBJECT', imageUrl: `${CDN}/v1717961679/art/moisestech-website/moisesdsanabria-babyagi_ewquhe.webp`, caption: 'Fabricated sculpture with robotic hands' },
      {
        key: 'public',
        label: 'PUBLIC',
        imageUrl: `${CDN}/v1739483633/art/moisestech-website/exhibitions/dec_2023_bakehouse_breadbytes/exhibition_shot_2_nbx7ky.jpg`,
        caption: 'Breadbytes exhibition — public encounter with machine-birth metaphor',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    publicContext: 'CONTINUUM — MUNAG, Antigua Guatemala (with The Price of Existence)',
    status: 'Exhibited',
    ...
    plausibility: {
      ...
      institutionalReality:
        'CONTINUUM at the National Museum of Art of Guatemala (MUNAG), with Bakehouse peers Fabiola Larios and Leo Castañeda — Smart Shoppers shown alongside The Price of Existence.',
      ...
      approvalsOrDependencies: [
        'CONTINUUM / MUNAG exhibition context',
        'Fundación Paiz / institutional install requirements',
      ],
      maintenance: 'Mechanical systems, software updates, gallery lighting.',
      documentationNeeded: ['Component audit photos', 'Fabrication timeline', 'Install documentation'],
    },
    credits: [
      { name: 'Moises Sanabria', role: 'Concept, fabrication', status: 'documented' },
      { name: 'Fabiola Larios', role: 'Bakehouse peer — CONTINUUM cohort', status: 'partial' },
      { name: 'Leo Castañeda', role: 'Bakehouse peer — CONTINUUM cohort', status: 'partial' },
    ],
    stages: [
      ...
      { key: 'public', label: 'PUBLIC', imageUrl: `${CDN}/v1737831876/art/moisestech-website/smart_shoppers__bsw9ko.jpg`, caption: 'CONTINUUM / MUNAG public installation context' },
    ],
  },
  {
    caseNumber: '04',
