...
export const resumeData = {
  ...
  experience: [
    ...
    },
    {
      ...
      description: [
        "UI/UX Developer building components cross browser compatible in Javascript/CSS."
      ]
    }
  ] as Experience[],
  ...
  education: [
    {
      ...
      period: "September 2011 - August 2014",
      location: "New York, NY"
    }
  ] as Education[],
  ...
  projects: [
    {
      name: "AI24 News",
      description: "Building a realtime news web-app allowing users to generate artistic illustrations of news articles in Desktop/Mobile using ReactJS.",
      technologies: [
        "NextJS",
        "Jotai",
        "Supabase",
  ...
  interests: [
    "Creative",
    "Machine Learning WebAI",
    "Image Gen Agentic AI"
  ]
} 