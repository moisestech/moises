...
export default function SquarespaceImplementationPage() {
  return (
    <ContentPage
      title="Squarespace Implementation Guide"
      description="Step-by-step guide to building and launching your website with Squarespace"
      icon={Settings}
      sections={[
        {
          ...
          content: (
            <div className="space-y-6">
              <p className="text-gray-600">
                Follow these steps to create and launch your website using Squarespace. This guide covers everything from initial setup to final deployment.
              </p>
        ...
        },
        {
          ...
          content: (
            <div className="space-y-4">
              <p className="text-gray-600">
                Explore these additional resources to enhance your Squarespace implementation:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link 
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Learn about Squarespace's layout system</p>
                  </div>
                </Link>
                <Link 
