...
const examples = [
  {
    ...
    icon: BookOpen,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/about"
  },
  {
    title: "Blog",
    description: "Explore our latest articles and insights",
    icon: MessageSquare,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/blog"
  },
  {
    title: "Case Studies",
    description: "Discover our successful projects and client stories",
    icon: Briefcase,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/case-studies"
  },
  {
    title: "Contact",
    description: "Get in touch with our team",
    icon: Contact,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/contact"
  },
  {
    title: "E-Commerce",
    description: "Browse our online store and products",
    icon: ShoppingCart,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/e-commerce"
  },
  {
    title: "Landing Pages",
    description: "View our collection of landing page designs",
    icon: Layout,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/landing-pages"
  },
  {
    title: "Landing",
    description: "Explore our main landing page design",
    icon: Home,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/landing"
  },
  {
    title: "Portfolio",
    description: "View our creative work and projects",
    icon: Globe,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/portfolio"
  },
  {
    title: "Pricing",
    description: "Check out our service packages and pricing",
    icon: CreditCard,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/pricing"
  },
  {
    title: "Services",
    description: "Learn about our range of services",
    icon: Briefcase,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/services"
  },
  {
    title: "Social Media",
    description: "Connect with us on social platforms",
    icon: Users,
    href: "/workshop/own-your-digital-presence/day/1/session/1/examples/social-media"
  }
];
