...
export const metadata: Metadata = {
  ...
  description:
    'Shop limited edition prints, merchandise, and digital artworks by Moises Sanabria.',
};
...
const products = [
  {
    ...
    price: '$500',
    description:
      'Archival pigment print on museum-quality paper. Edition of 25, signed and numbered.',
    dimensions: '80 x 120 cm',
    image:
      'https://res.cloudinary.com/dck5rzi4h/image/upload/v1717962487/art/moisestech-website/vr_hug_moisesdsanabria_tomgalle_2017_csfeef.jpg',
  },
  {
    title: 'Digital Divinities - NFT Collection',
    price: '2.5 ETH',
    description:
      'A collection of unique AI-generated digital sculptures exploring divinity in the digital age.',
    image:
