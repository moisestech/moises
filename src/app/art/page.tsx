...
export const metadata: Metadata = {
    ...
    description: 'Explore the work and biography of Moises Sanabria, an interdisciplinary artist working at the intersection of technology and contemporary society.',
};
