                ...
                {artwork.images.length > 0 && (
                    <div className="mt-24">
                        <h2 className="text-3xl font-bold mb-8">
                            {artwork.images.length} Variation{artwork.images.length !== 1 ? 's' : ''} Online
                        </h2>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {artwork.images.map((image, index) => (
                                <div key={index} className="aspect-square relative group cursor-pointer">
                                    <Image
                                        src={image.url}
                                        alt={image.caption || `${artwork.title} - Variation ${index + 1}`}
                                        fill
                ...
                <div className="mt-24 border-t border-gray-200 dark:border-gray-800 pt-16">
                    <div className="max-w-3xl mx-auto text-center">
                        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                            ...
                            {artwork.curator && ` Special thanks to ${artwork.curator} for the curatorial vision and support.`}
                        </p>
                    </div>
                </div>
            </div>
