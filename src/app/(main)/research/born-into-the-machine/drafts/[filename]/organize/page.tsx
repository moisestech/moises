...
import { ChapterBuilder } from '@/components/book/ChapterBuilder';
...
export default async function OrganizePage({ params }: OrganizePageProps) {
  ...
  try {
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <ChapterBuilder analysis={analysis} filename={decodedFilename} />
      </div>
    );
  } catch (error) {
    notFound();
